...
void ShowVersion(void)
{
	...
	Serial.printf("J\r\n");
#endif
	Serial.printf("SN: %d    HW: %d.%d",AuthSN,AuthHW>>8,AuthHW&0xff);
	ShowLink();
}
...
{
//***FIX***
Serial.printf("DID: %08X,  CPU: %X,  Family: %X\r\n",DSU->DID.reg,DSU->DID.bit.PROCESSOR,DSU->DID.bit.FAMILY);
	...
	if (BatteryType) // If we have selected a battery
	{
		...
		if (!BufferBlank)
		{
			...
			if (PPP_V2 == BatteryType)
				Serial.println("    MV2  - Manufacture V2 battery");
		}
