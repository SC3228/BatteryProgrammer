...
#define MC18_BATT			2	// MC18 battery (MPA3 PP+)
#define ROGUE_BATT			3	// Rouge battery
#define FRENZY_BATT			4	// Frenzy battery
#define IRONMAN_BATT		5	// IronMan battery
#define POLLUX_BATT			6	// Pollux battery
#define	FALCON_BATT			7	// Falcon battery
#define HAWKEYE_BATT		8	// Hawkeye battery
#define SENTRY_E_BATT		9	// Sentry battery
#define SENTRY_A_BATT		10	// Sentry battery
#define BEAST_E_BATT		11	// Beast battery
#define BEAST_A_BATT		12	// Beast battery
...
#define MAX_BATTERY_TYPES 13  // Number of supported battery types
...
extern uint8_t PPP_Valid; // Battery PP+ data valid flag
extern uint8_t PP_Valid; // Battery PP data valid flag
