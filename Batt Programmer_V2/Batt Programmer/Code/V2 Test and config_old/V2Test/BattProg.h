...
#define STATUS_LED_ONLINE	{statusLED.setPixelColor(0,0,0,255);statusLED.show();}
#define STATUS_LED_WAITING	{statusLED.setPixelColor(0,255,255,0);statusLED.show();}
#define STATUS_LED_READY	{statusLED.setPixelColor(0,0,255,0);statusLED.show();}
#define STATUS_LED_BUSY		{statusLED.setPixelColor(0,255,0,0);statusLED.show();}
