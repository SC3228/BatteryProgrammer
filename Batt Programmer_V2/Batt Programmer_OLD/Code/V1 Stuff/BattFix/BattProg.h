...
#define LIGHTNING_A_BATT	7	// Lightning battery using auth data
#define POLLUX_BATT			8	// Pollux battery
#define	FALCON_BATT			9	// Falcon battery
#define HAWKEYE_BATT		10	// Hawkeye battery
#define SENTRY_E_BATT		11	// Sentry battery
#define SENTRY_A_BATT		12	// Sentry battery
#define BEAST_E_BATT		13	// Beast battery
#define BEAST_A_BATT		14	// Beast battery
